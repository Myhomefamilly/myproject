...
class Article(db.Model):
    ...
    user = db.relationship('User', primaryjoin="Article.id==foreign(User.id)",uselist=False)
...
class Comment(db.Model):
    ...
    user = db.relationship('User', primaryjoin="Comment.id==foreign(User.id)",uselist=False)
    article = db.relationship('Article', uselist=False)
